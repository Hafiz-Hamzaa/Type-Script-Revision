...
let bigInt1 = 987654321n;
let sum = bigInt + bigInt1;
console.log(sum);
...
// Rest Parameters
function RestPara(age, ...unknown) {
    console.log(age);
    console.log(unknown);
}
RestPara(1, 2.4, 23, 3456, 78);
function SpreadPara(age, ...unknown) {
    console.log(age);
    console.log(...unknown);
}
...
console.log(global);
// Anonymous Function
let anonymousFunc = function (isMarried) {
    return isMarried;
};
...
console.log(numerical);
// Array Methods
let car = ["civic", "honda", "corlla"];
car.reverse();
console.log(car); // reverse
let vege = ["onion", "carrot", "lemon"];
...
console.log(vege);
// slice
let grocery = ["corn", "sugar", "salt", "rice", "cookies"];
console.log(grocery.slice(1, 4));
// splice
let numbers = [12, 45, 78, 90, 78];
...
let BestFriends = ["Areeba", "Laiba", "Ayesha"];
